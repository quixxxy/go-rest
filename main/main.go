...
func main() {
	...
	people = append(people, Person{ID: "1", Firstname: "Sergii", Lastname: "Iakymenko", Address: &Address{City: "Bellevue", State: "WA"}})
	people = append(people, Person{ID: "2", Firstname: "Daria", Lastname: "Iakymenko"})
